...
void splitStringAtWord(String input, String &part1, String &part2) {
  ...
  if (lastSpaceIndex != -1) {
    part1 = input.substring(0, lastSpaceIndex);
    part2 = input.substring(lastSpaceIndex + 1);
  } else {
  ...
  do
  {
    ...
    for (int i = 0; i < GSR.getEntryCount(); i++)
    {
      ...
      if(task_description != "") {
          ...
          splitStringAtWord(task_description, sub_str1, sub_str2);
