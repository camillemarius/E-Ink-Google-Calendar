...
// Set fonts
const GFXfont *fontMassiveTitle = &FreeSans24pt7b;
...
const char * monthNumbers[] = { "Januar", "Februar", "Marz", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober", "November", "Dezember"};
